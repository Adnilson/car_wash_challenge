...
class CarTest < ActiveSupport::TestCase
  ...
  test "Fields presence validations" do
    car = Car.new(year: 2021, color: 'blue', license_plate: '37-DS-22', price: 320, model: @model)
    car2 = Car.new(color: 'blue', license_plate: '17-DS-22', price: 320, model: @model)
    car3 = Car.new(year: 2021, license_plate: '17-DS-22', price: 320, model: @model)
    car4 = Car.new(year: 2021, color: 'blue', price: 320, model: @model)
    car5 = Car.new(year: 2021, color: 'blue', license_plate: '17-DS-22', model: @model)
    car6 = Car.new(year: 2021, color: 'blue', license_plate: '17-DS-22', price: 320)
  ...
  test "license_plate uniqueness validation" do
    Car.create(year: 2021, color: 'blue', license_plate: '17-DS-22', price: 320, model: @model)
    second = Car.new(year: 2021, color: 'blue', license_plate: '17-DS-22', price: 320, model: @model)
